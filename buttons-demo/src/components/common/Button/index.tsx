  ...
  (
    ...
    return (
      ...
      >
        ...
        {finalStartContent && !isLoading && !isIconOnly && (
        ...
        {finalEndContent && !isIconOnly && (
          <span className="flex items-center justify-center w-4 h-4 ml-2">
            {finalEndContent}
          </span>
        )}
      </button>
