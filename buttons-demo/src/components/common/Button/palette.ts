...
export const semanticColors = {
  ...
  button: {
    primary: {
      ...
      text: colorPalette.neutral[900], // ЧЁРНЫЙ текст для solid согласно Figma
      textDisabled: colorPalette.neutral[600], // Ещё более приглушённый серый
      colorText: colorPalette.primary[500], // Бирюзовый для light/flat вариантов
    },
    secondary: {
      ...
      text: colorPalette.neutral[900], // ЧЁРНЫЙ текст для золотых кнопок
      textDisabled: colorPalette.neutral[600], // Ещё более приглушённый серый
      colorText: colorPalette.gold[700], // Тёмно-золотой для light/flat вариантов
    },
    success: {
      ...
      text: colorPalette.neutral[50], // БЕЛЫЙ текст для зелёных кнопок
      textDisabled: colorPalette.neutral[600], // Ещё более приглушённый серый
      colorText: colorPalette.green[600], // Тёмно-зелёный для light/flat вариантов
    },
    info: {
      ...
      text: colorPalette.neutral[50], // БЕЛЫЙ текст для синих кнопок
      textDisabled: colorPalette.neutral[600], // Ещё более приглушённый серый
      colorText: colorPalette.blue[600], // Тёмно-синий для light/flat вариантов
    }
  }
} as const; 