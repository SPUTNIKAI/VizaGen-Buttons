...
const createColorVariables = (colors: any) => ({
  ...
  '--btn-color': colors.default, // Цвет для light/flat текста
});
...
export const buttonVariants = {
  ...
  variant: {
    ...
    light: [
      "bg-[var(--btn-color)]/10",
      "text-[var(--btn-color)]",
      "hover:bg-[var(--btn-color)]/20",
      "active:bg-[var(--btn-color)]/30",
      "disabled:bg-[var(--btn-bg-disabled)]/10",
      "disabled:text-[var(--btn-text-disabled)]",
      "border",
      "border-[var(--btn-color)]/20",
      "hover:border-[var(--btn-color)]/40",
    ].join(" "),
    
    flat: [
      "bg-[var(--btn-color)]/20",
      "text-[var(--btn-color)]",
      "hover:bg-[var(--btn-color)]/30",
      "active:bg-[var(--btn-color)]/40",
